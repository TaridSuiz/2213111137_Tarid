...
public class Lab303 {
	...
	public static void main(String[] args) {
		...
		if (B_lance > balance) {
			JOptionPane.showMessageDialog(null, "Error:Cannot withraw more than balance", "ERROR",
					JOptionPane.ERROR_MESSAGE);
		} else if (B_lance >= 20000) {
			JOptionPane.showMessageDialog(null, "Error:Cannot withraw more than 20,000", "ERROR",
					JOptionPane.ERROR_MESSAGE);
		}

		else if (bank03 != 0) {
			JOptionPane.showMessageDialog(null, "Error:Cannot withraw " + B_lance%100 + " Baht", "ERROR",
					JOptionPane.ERROR_MESSAGE);
		} else {
